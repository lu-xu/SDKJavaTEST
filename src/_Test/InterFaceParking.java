...
//					MainSDK.ticket_id.setText(object.getString("duration"));
		...
		case "nolicence_in_park":
			...
			if(stateinjson.getString("state").equals("1")){
				...
				back = "{\"service_name\":\"nolicence_in_park\",\"data_target\":\"bolink\",\"state\":1,\"errmsg\":\"生成无牌车订单\",\"user_uuid\":\""+user_uuid+"\"}";
			}else{
				back = "{\"service_name\":\"nolicence_in_park\",\"data_target\":\"bolink\",\"state\":0,\"errmsg\":\"生成无牌车订单失败\",\"user_uuid\":\""+user_uuid+"\"}";
			}
//			try {
//				Thread.sleep(5000);
